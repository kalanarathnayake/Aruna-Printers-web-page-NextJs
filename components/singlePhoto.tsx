...
const SinglePhotoBooth = () => {
    return (
        <div className="container mx-auto">
            <div className="object-center px-5 pb-10 duration-300 bg-center hover:scale-110 drop-shadow-2xl lg:max-w-full lg:ml-28 lg:px-32">
                <img src="https://media.discordapp.net/attachments/815160100993499176/1109374598232940605/img3.jpg?width=1005&height=670" alt="Events" />
            </div>
        </div>
    );
};
